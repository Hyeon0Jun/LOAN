...
include('db.php');
$user=$_SESSION['id'];
$sql = "SELECT * FROM loanproduct inner join interestrate on loanproduct.loan_num = interestrate.loanproduct_loan_num where loanproduct.loanclassification='신용대출'";
