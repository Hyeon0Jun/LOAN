...
include('db.php');
$user=$_SESSION['id'];
$sql = "SELECT * FROM loanproduct where loanproduct.loanclassification='부동산담보대출'";
$usql = "SELECT realestate FROM member WHERE id='$user'";
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_array($ret)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $urow['realestate']*$row['l_realestate'] ?></td>
