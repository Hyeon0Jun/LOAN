                                  ...
                                  <tbody>
                                    <?php while($row = mysqli_fetch_array($ret)) { ?>
                                      ...
                                      <tr>
                                          ...
                                          <td> <a class="btn btn-secondary" href="loanupdate.php?loan_num=<?php echo $row['loan_num']?>">수정</a></td>
                                          <td> <a class="btn btn-secondary" href="loandelete.php?loan_num=<?php echo $row['loan_num']?>">삭제</a></td>
                                      </tr>
                                    <?php } ?>
                                  </tbody>
                              </table>
